...
//
//-----------------------------------
double* CCoxPH::StatusVec() { return &status_[0]; }
const double* CCoxPH::StatusVec() const { return &status_[0]; }
...
//
//-----------------------------------
int* CCoxPH::EndTimeIndices() { return &sortedendtimes_[0]; }
const int* CCoxPH::EndTimeIndices() const { return &sortedendtimes_[0]; }
...
//
//-----------------------------------
int* CCoxPH::StartTimeIndices() { return &sortedstarttimes_[0]; }
const int* CCoxPH::StartTimeIndices() const { return &sortedstarttimes_[0]; }
...
//
//-----------------------------------
int* CCoxPH::StrataVec() { return &strata[0]; }
const int* CCoxPH::StrataVec() const { return &strata[0]; }
...
//
//-----------------------------------
int CCoxPH::TieApproxMethod() const { return tiedtimesmethod_; }
...
//
//-----------------------------------
double CCoxPH::PriorCoeffVar() const { return kPriorCoeffVariation_; }
