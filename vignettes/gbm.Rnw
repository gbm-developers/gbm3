...
function is part of the original R API provided by the package; while this API is
still functional, as of Version 2.1.06 the package contains an updated API which
