...
#' 
#' @usage gbm_cv_errors(gbm_cv_fit, train_params, cv_folds, cv_group)
#' 
...
gbm_cv_errors.GBMCVFit <- function(gbm_cv_fit, train_params, cv_folds, cv_group) {
  ...
  cv_error <- vapply(1:cv_folds,
                     ...
                     }, double(train_params$num_trees))
  ## this is now a (num_trees, cv_folds) matrix
  ## and now a n.trees vector
  return(rowSums(cv_error) / train_params$num_train)
}